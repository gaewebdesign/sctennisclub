...
<?php 
  // relative to signup.html directory
  include "./library/include.inc";
  $MEMBER_FEE="5.00";    // "5.00";
...
//  <img src="./signup_/icecreamsocial.png">  
...
<div class="py-5 text-center">
  <picture>
    <img class="mg-fluid img-thumbnail" src="./signup_/icecreamsocial.png" alt="" >
  </picture>
...
-->
      ...
      <div class="col-md-7 col-lg-8">
        ...
        <form class="needs-validation" novalidate name="signup" action="./signup_/topaypal.php", method="post" >
          <div class="row g-3">
            <div class="col-sm-6">
