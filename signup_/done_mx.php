...
<body class="Back">
    <center>
    <h1> Thanks <?php echo( $_GET["item_number"]);?> for signing up to the SCTC mixer!
    <p> View your name under the participants list<br>
    <a href="http://www.sctennisclub.org/sctcmixer">www.sctennisclub.org/sctcmixer</a>
    </h1>
<!--
