...
//(  ADD  to address)
if( preg_match( "/2893 Cabrillo/", $address)  ) $address = $addresss."-".password();
if( preg_match( "/3410 Montgomery/", $address)  ) $address .= $address."-".password();
if( preg_match( "/2868 Chromite/", $address)  ) $address .= $address."-".password();
if( preg_match( "/2988 Via Torino/", $address)  ) $address .= $address."-".password();
if( preg_match( "/2566 Dixon/", $address)  ) $address .= $address."-".password();
